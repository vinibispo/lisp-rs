...
fn eval_binary_op(list: &Vec<Object>, env: &mut Rc<RefCell<Env>>) -> Result<Object, String> {
    ...
    match (operator, left, right) {
        (Object::Symbol(s), Object::Integer(left_val), Object::Integer(right_val)) => {
            match s.as_str() {
        ...
        (Object::Symbol(s), Object::Float(left_val), Object::Float(right_val)) => {
            match s.as_str() {
                "+" => Ok(Object::Float(left_val as f64 + right_val as f64)),
                "-" => Ok(Object::Float(left_val as f64 - right_val as f64)),
                "*" => Ok(Object::Float(left_val as f64 * right_val as f64)),
                "/" => Ok(Object::Float(left_val as f64 / right_val as f64)),
                "<" => Ok(Object::Bool(left_val < right_val)),
        ...
        (Object::Symbol(s), Object::Float(left_val), Object::Integer(right_val)) => {
            match s.as_str() {
                "+" => Ok(Object::Float(left_val + right_val as f64)),
                "-" => Ok(Object::Float(left_val - right_val as f64)),
                "*" => Ok(Object::Float(left_val * right_val as f64)),
                "/" => Ok(Object::Float(left_val / right_val as f64)),
                "<" => Ok(Object::Bool(left_val < right_val as f64)),
                ">" => Ok(Object::Bool(left_val > right_val as f64)),
                "=" => Ok(Object::Bool(left_val == right_val as f64)),
                "!=" => Ok(Object::Bool(left_val != right_val as f64)),
                _ => Err(format!("Invalid infix operator: {}", s)),
        ...
        (Object::Symbol(s), Object::Integer(left_val), Object::Float(right_val)) => {
            match s.as_str() {
                "+" => Ok(Object::Float(left_val as f64 + right_val)),
                "-" => Ok(Object::Float(left_val as f64 - right_val)),
                "*" => Ok(Object::Float(left_val as f64 * right_val)),
                "/" => Ok(Object::Float(left_val as f64 / right_val)),
                "<" => Ok(Object::Bool((left_val as f64) < right_val)),
                ">" => Ok(Object::Bool(left_val as f64 > right_val)),
                "=" => Ok(Object::Bool(left_val as f64 == right_val)),
                "!=" => Ok(Object::Bool(left_val as f64 != right_val)),
                _ => Err(format!("Invalid infix operator: {}", s)),
...
mod tests {
    ...
    fn test_circle_area_function() {
        ...
        assert_eq!(
            result,
            Object::List(vec![Object::Float((3.14 * 10 as f64 * 10 as f64) as f64)])
        );
    }
}
